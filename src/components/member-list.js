            ...
            members: [
                {
                    ...
                    second: 'Алексеевич',
                    group: 'ИУ8-41',
                    desc: 'Backend - разработчик. Невропатолог серверной стороны сайтов. Целеустремленный, впитывающий знания программист. Ответственно подходит к разработке, помогает проводить Review-кода команды.\n\nStack-технологий = [\n\tBackend => [ Python, Perl, C++ ],\n\tframework => [ Flask, Vue ],\n\tTechnology => [ Git, Heroku ]\n]',
                ...
                },
                {
                    ...
                    second: 'Алексеевич',
                    group: 'ИУ8-41',
                    desc: 'Волею судьбы занимаюсь дизайном, хотя предпочел бы серверную часть. Иногда интуитивно вставляю костыли, которые непостижимым для него образом оказываются рабочими. Не люблю Python из-за не-си-подобного синтаксиса.',
                ...
                },
                {
                    ...
                    second: 'Дмитриевич',
                    group: 'ИУ8-41',
                    desc: 'Прирожденный дизайнер. Могу сверстать вам сайт за 5 минут на коленках в метро в час пик. Из любого тапка с помощью HTML5/CSS3/JS/SASS(UKE)/GULP/React.JS/Node.js/Vue.js сделаю вам шедевр мирового уровня за скромное вознаграждение. Мастер merge конфликтов. Ношу ray ban, пью кофе из старбакса и делаю подвороты. На вашу фичу “анимированные картинки” отвечаю своим статическим дизайном и паром из вейпа в лицо.',
